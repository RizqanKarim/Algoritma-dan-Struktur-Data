...
int main () 
{
    ...
    if(menu==1){
        ...
        cout << "\nTERIMA KASIH" << endl;
        cout << "Program was made by Muhammad Rizqan Karim (2410817110005)." << endl;
    }
}
...
void tampilkanH() {
    ...
    if(isEmptyH() == 0) {
        ...
        cout << endl;
    } else cout << "Tidak terdapt data pada Linked List";
}
...
void clearHT() {
    ...
    initHT();
    cout << "Seluruh data pada Linked List telah diberihkan.";
}